...
adj_milk_cow_day <- reactive({  browser()
  rv$adj_milk_cow_day <- input$milk_cow_day * input$milk_cow_coeff +  
    + input$milk_cow_day * input$milk_fat/100 * input$milk_fat_coeff
  rv$adj_milk_cow_day 
})

adj_milk_cow_day2 <- reactive({  browser()  # adj_milk_cow_day with the herd size under using robots
...
DMI_projected <- reactive({  browser()

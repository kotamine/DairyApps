...
#   observe({
#   
#     need(length(ans[[x]]$net_annual_impact_after_tax)>0, "NA") %>% validate()
    ...
    isolate({
      ...
      ans[[paste0(x,"_da")]]$IOFC_cwt <- ans[[paste0(x,"_da")]]$IOFC /365 /input$milk_cow_day * 330 
      
      ans[[paste0(x,"_da")]]$IOFC2_cwt <- ans[[paste0(x,"_da")]]$IOFC2 /365 /ans[[x]]$milk_day_cow_alt * 330 
      ...
      ans[[paste0(x,"_da")]]$inflation <- - pmt(ans[[x]]$avg_interest/100, ans[[x]]$planning_horizon, 
